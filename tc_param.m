function varargout = tc_param(varargin)
% TC_PARAMS MATLAB code for tc_params.fig
%      TC_PARAM, by itself, creates a new TC_PARAM or raises the existing
%      singleton*.
%
%      H = TC_PARAM returns the handle to a new TC_PARAM or the handle to
%      the existing singleton*.
%
%      TC_PARAM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TC_PARAMS.M with the given input arguments.
%
%      TC_PARAM('Property','Value',...) creates a new TC_PARAM or raises the
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @tc_param_OpeningFcn, ...
                   'gui_OutputFcn',  @tc_param_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function tc_param_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = tc_param_OutputFcn(hObject, eventdata, handles) 
